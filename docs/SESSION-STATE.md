...
| **➡️ NEXT** | **BUILD-PLAN Step 7 — attachments.** Needs a Supabase Storage bucket, so **ask the owner before starting**. Steps 1–6 done. **788 unit · 115 integration · 25 smoke.** |
