...
import { primaryActionFor, type CreateKind } from './primary-action';

/* Who may see money. ⚠️ DELIBERATELY NOT the `ADMIN_UP` inside
   `primary-action.ts`, which decides who is offered a "New project" button. The
   comment at `canSeeFinance` below has said since it was written that the two
   gates are independent and one of them will move — sharing one constant is how
   a change to the button would quietly change who sees payroll. */
